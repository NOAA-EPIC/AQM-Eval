...
export in_dir=/gpfs/f6/bil-fire8/scratch/Benjamin.Koziol/sandbox/srw/benkozi/aqm-reldeb/expt_dirs/aqm_AQMNA13km_AEROMMA
export out_dir=/gpfs/f6/bil-fire8/scratch/Benjamin.Koziol/tmp/MM-run/Alldays
export predix="aqmv8p1.metemis.ish"
